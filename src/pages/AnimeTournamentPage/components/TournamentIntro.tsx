  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] sm:min-h-[60vh] text-center">
      ...
      <div className="mt-8 sm:mt-12 max-w-xs sm:max-w-lg md:max-w-lg">
        <h3 className="font-semibold mb-3 sm:mb-4 text-foreground text-sm sm:text-base">{t('tournament.howItWorks')}</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-sm">
          <div className="p-3 sm:p-4 bg-muted/50 border border-border rounded-lg">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">🎯</div>
            <p className="text-foreground text-xs sm:text-sm">{t('tournament.stepPick')}</p>
          </div>
          <div className="p-3 sm:p-4 bg-muted/50 border border-border rounded-lg">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">⚔️</div>
            <p className="text-foreground text-xs sm:text-sm">{t('tournament.stepRounds')}</p>
          </div>
          <div className="p-3 sm:p-4 bg-muted/50 border border-border rounded-lg">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">👑</div>
            <p className="text-foreground text-xs sm:text-sm">{t('tournament.stepBest')}</p>
          </div>
        </div>
      </div>
    </div>
